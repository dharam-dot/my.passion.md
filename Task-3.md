...
| **2** | Rename the download file | mv "pub?output=csv" output1.csv | Using mv command  downloaded file succefully rename. | After using mv command  downloaded file succefully rename.  | **Passed** | Testing has been passed |
